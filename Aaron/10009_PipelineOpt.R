## Optimised deep learning pipeline.
...
# Extract the weights.
ae.weights <- list(l1 = as.matrix(h2o.weights(AE, 1)), l2 = as.matrix(h2o.weights(AE, 2)), l3 = as.matrix(h2o.weights(AE, 3)))

# Save the weights.
#saveRDS(ae.weights, "AutoEncoderWeights.rds")
